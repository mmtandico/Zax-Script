--[[
    Zxscript - Professional Universal Loader / Bootstrapper
    Inspired by BFLoader architecture. Supports game routing, key passing, 
    cache-busting, and double-execution protection.
]]
...
-- If already running this route name, prevent duplicate GUI launch
if state.loaded[route[1]] then
    warn("[Zxscript] Loader already running for: " .. tostring(route[1]))
    return
end
